document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchTextFromSheet() {
        ...
        const range = 'Prices!A1:C'; // Adjust the range according to your needs
    ...
    document.getElementById('aboutPButton').addEventListener('click', function() {
    ...
    document.getElementById('pricesButton').addEventListener('click', function() {
        window.location.href = 'prices.html'; // Replace with the actual URL
    });
